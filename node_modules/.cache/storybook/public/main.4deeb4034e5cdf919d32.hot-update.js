            ...
            <div className="bg-yellow-550 justify-center w-263.75 h-119.5">
              <div className="justify-center items-center">
                <div className="flex w-263.75 justify-end items-end ">
                  <button
                    onClick={close}
                    className=" rounded-md px-4 py-2 inline-flex justify-end items-end hover:text-gray-500 
                    ...
                    <div className="">
                      <div>
                        ...
                        <input
                          ...
                          required
                          className="placeholder-blue-850 bg-white text-center text-xl  w-171.25 h-12.5 
                      ...
                      <select className="block w-171.25 h-12.25 font-rubik text-xl text-center mt-4 bg-white 
                      border-blue-850 shadow-lg focus:border-indigo-300 focus:ring focus:ring-indigo-200 
...
//# sourceMappingURL=main.4deeb4034e5cdf919d32.hot-update.js.map