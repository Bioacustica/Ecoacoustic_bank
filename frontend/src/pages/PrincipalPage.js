        ...
        <div className="flex items-center justify-center " id="visualizacion">
          <div className="bg-blue-250 w-341.5 ">
            ...
            <div className="flex justify-center items-center mb-11.25 ">
              <div>
                <button className=" bg-white mr-7.5 border-solid border-2 w-128.75 h-130 border-black hover:bg-gray-300">
                  ...
                  <div className="texto m-6.25">
                    ...
                    Details of the metadata used to describe the conditions under which audios were collected.
                    </p>
                  </div>
                </button>
              </div>
              ...
              <div>
                <button className=" bg-white  border-solid border-2 w-128.75 h-130 border-black hover:bg-gray-300">
                  <div className="imagen bg-pink-100 w-128.5 h-73">
                    <img src={map} alt="" />
                  </div>
                  <div className="texto m-6.25">
                    ...
                    <p className="text-xl font-normal text-justify font-rubik text-blue-850">
                    Display information about the locations where the recordings were taken.
                    </p>
                  </div>
                </button>
              </div>
