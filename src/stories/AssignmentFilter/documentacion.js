...
export function CustomDocumentationComponent() {
  ...
  return (
    ...
    <div >
      ...
      <p>
        Este componente hace referencia al filtro de asignacion de permisos en el panel del administrador.
      </p>
      </div>
      ...
      <pre  className='border-2'>{
        ...
        <div className="flex justify-center items-center content-center mb-8.5">
          <div className="flex w-341.5 justify-center items-center">
            ...
            <label className="block text-center w-54.25 ">
              ...
              <select className="block w-full rounded-md bg-white border 
              border-blue-850 shadow-lg 
              focus:border-indigo-300 focus:ring focus:ring-indigo-200 
              focus:ring-opacity-50 mt-1 h-7.75">
                <option value={null}>seleccionar</option>
        ...
        <div className="flex justify-center items-end mb-5">
          <div className="w-260 items-end">
            <div className=" font-rubik font-semibold text-base inline-flex  text-center 
            justify-end w-full">
          ...
          >
           ...
           "bg-white border-gray-300 text-gray-500 hover:bg-gray-50" */}
            <a
              href="#"
              aria-current="page"
              className="z-10 bg-green-450 border-green-450 text-white relative inline-flex 
            ...
            <span className="relative inline-flex items-center px-4 py-2 border border-gray-300
