...
export function CustomDocumentationComponent() {
  ...
  return (
    ...
    <div >
      ...
      <h1 >Tabla filtro de asignacion</h1>
      </div>
      <br/>
      <code>
      ...
      <p>
      Este componente hace referencia a la tabla del filtro de asignacion de permisos en el panel del administrador.
      </p>
      </div>
        ...
        <table className=" border border-collapse ">
          ...
          <tbody>
            {columns.map((rowscounter) => (
              <tr className="">
                <td className="border-2 font-rubik border-blue-850 font-light
                 text-base h-13.5 px-4 text-center">
