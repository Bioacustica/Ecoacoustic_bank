...
export function CustomDocumentation() {
  return (
    ...
    <div >
      ...
      <p>
        Este componente hace parte del panel de control de usuarios que tiene el administrador, permite agregar usuarios a la base de datos.
      </p>
      </div>
      ...
      <p>
       closeimg: Varible que contiene una imagen de la <kbd>X</kbd> mostrada en la parte superior derecha del modal 
      </p>
      <br/>
              ...
              <div className="justify-center items-center">
                <div className="flex w-263.75 justify-end items-end ">
                  <button
                    ...
                    items-end hover:text-gray-500 
                    hover:shadow-2xl focus:outline-none focus:shadow-lg"
                  >
                    ...
                    <div className="">
                      <div>
                        ...
                        <input
                          ...
                          w-171.25 h-12.5 
                          font-rubik border-2  border-white border-opacity-100 "
                        />
                        </div>
                      ...
                      <select className="block w-171.25 h-12.25 font-rubik text-xl text-center
                       mt-4 bg-white 
                     ...
                     <input
                        ...
                        required
                        className="mt-4 w-171.25 text-center h-12.5 placeholder-blue-850
                         bg-white font-rubik"
                      ></input>
                     </div>
