...
export function CustomDocumentationComponent() {
  ...
  return (
    ...
    <div >
      ...
      <p>
        Este componente hace referencia al filtro publico en la pagina inicial de la aplicacion.
      </p>
      </div>
      ...
      <pre  className='border-2'>{
          ...
          <div className="flex w-341.5 justify-center items-center">
            <label className="block text-center w-54.25 mr-41.5">
              ...
              onChange={event=>this.valueToState(event.target)}
                disabled
                className="block w-full border border-blue-850 rounded-md bg-white 
                 shadow-lg focus:border-indigo-200 focus:ring focus:ring-indigo-200
        ...
        <div className="flex justify-center items-center content-center mb-8.5">
          <div className="flex w-341.5 justify-center items-center">
            ...
            <label className="block text-center w-54.25">
              <br />
              <button className="block  font-semibold font-poppins text-white 
              bg-green-550 hover:shadow-lg hover:opacity-70 w-54.25 h-7.75 ">
                Buscar
              </button>
            </label>
          </div>
