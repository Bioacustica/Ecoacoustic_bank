...
export function CustomDocumentationComponent() {
  ...
  return (
    ...
    <div >
      ...
      <p>
      Este componente hace referencia al filtro de descargas en el panel del administrador.
      </p>
      </div>
          ...
          <div className="flex w-341.5 justify-center items-center">
            ...
            <label className="block text-center w-54.25 mr-15.666">
              ...
              <select
                ...
                focus:ring-opacity-50 h-7.75 mt-1"
              >
                <option value={null}>seleccionar</option>
            ...
            <label className="block text-center w-54.25 ">
              ...
              focus:border-indigo-300 focus:ring focus:ring-indigo-200 
              focus:ring-opacity-50 mt-1 h-7.75">
                <option value={null}>seleccionar</option>
        ...
        <div className="flex justify-center items-center content-center mb-8.5">
          <div className="flex w-341.5 justify-center items-center">
            <label className="block text-center w-54.25 mr-15.666">
              ...
              <select className="block w-full rounded-md bg-white border border-blue-850
               shadow-lg focus:border-indigo-300 focus:ring focus:ring-indigo-200 
               focus:ring-opacity-50 mt-1 h-7.75">
                <option value={null}>seleccionar</option>
        ...
        <div className="flex justify-center items-center content-center ">
          <div className="flex w-341.5 justify-center items-center">
            <label className="block text-center w-54.25 mr-15.666">
              ...
              <select className="block w-full mt-1 rounded-md bg-white border 
              border-blue-850 shadow-lg focus:border-indigo-300 focus:ring 
              focus:ring-indigo-200 focus:ring-opacity-50 h-7.75">
                <option value={null}>seleccionar</option>
            ...
            <label className="block text-center w-54.25 mr-15.666">
              ...
              <input
                type="date"
                className="mt-1 block w-full h-7.75 rounded-md border border-blue-850 
                shadow-lg focus:border-indigo-300 focus:ring focus:ring-indigo-200 
            ...
            <label className="block text-center w-54.25 mr-15.666">
              ...
              <input
                type="date"
                className="mt-1 block w-full rounded-md border border-blue-850 
                h-7.75 shadow-lg focus:border-indigo-300 focus:ring 
        ...
        <div className="flex justify-center items-center content-center mb-8.5">
          <div className="flex w-341.5 justify-center items-center">
            <label className="block text-center w-54.25 mr-15.666 mt-8.5">
              ...
              <input
                type="text"
                className="mt-1 block w-full rounded-md border border-blue-850 h-7.75 
                shadow-lg focus:border-indigo-300 focus:ring focus:ring-indigo-200
                 focus:ring-opacity-50"
              />
            </label>
            ...
            <label className="block text-center w-54.25 mr-15.666">
              <br />
              <div>
                <button className="block mb-2 font-semibold text-xl font-poppins 
                text-white bg-gray-250 hover:shadow-lg w-54.25 h-7.75 ">
                  Buscar
                </button>
              </div>
              <div>
                <button className="block font-semibold  text-xl font-poppins 
                text-white bg-gray-250 hover:shadow-lg  w-54.25 h-7.75 ">
                  Descargar
                </button>
              </div>
            ...
            <label className="block  text-center w-54.25 ">
              ...
              <div className="flex">
                <input
                  ...
                  type="checkbox"
                />
                <label className="block  mb-2 font-semibold text-2xl font-poppins
                 text-white bg-blue-250 w-45.5 h-7.75 ">
                  Excel
                </label>
              </div>
              <div className="flex">
                <input
                  ...
                  type="checkbox"
                />
                <label className="block  font-semibold font-poppins text-2xl 
                text-white bg-blue-250 w-45.5 h-7.75 ">
                  CSV
                </label>
              </div>
