                                    ...
                                    <div className="card-body p-4 p-lg-5 text-black">
                                        <form>
                                            ...
                                            <div className="md-form form-lg  md-bg input-with-pre-icon">
                                                ...
                                                <input type="text" placeholder="Usuario" className="form-control form-control-lg" />
                                            </div>
                                            <div className="md-form md-bg md-bg input-with-pre-icon">
                                                <i class="fas fa-key input-prefix"></i>
                                                <input type="password" placeholder="Contraseña" className="form-control form-control-lg" />
                                            </div>
                                            <div className="pt-1 mb-4 ">
                                                <button className="btn btn-dark btn-sm btn-block rounded-pill w-100 " type="button">
                                                    Entrar
                                                </button>
                                            </div>
                                            <p className="mb-5 mt-2 pb-lg-2 " style={{ color: "#393f81" }}>
